...
runners.forEach(function(element1,) {
    console.log(element1.first_name);
});

runners.forEach(function(element2,) {
    console.log(element2.first_name);
});
...
const allCaps = allCaps.map(function callback(currentValue){
